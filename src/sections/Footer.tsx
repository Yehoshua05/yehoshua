...
import { ArrowUpRight, Linkedin, Github, Twitter, Mail, Circle, type LucideIcon } from 'lucide-react';
          ...
          >
            {footerConfig.logo && (
              <a href="#" className="inline-block">
                <img src={footerConfig.logo} alt="Yehoshua Logo" className="h-12 w-auto" />
              </a>
            )}
