...
export function Testimonials() {
  ...
  return (
    <section id="testimonials" className="w-full py-24 lg:py-32 bg-exvia-black">
      <div ref={sectionRef} className="container-large px-6 lg:px-12">
        ...
        <div className="max-w-2xl mb-16">
          {testimonialsConfig.label && (
            ...
            >
              <span className="text-xs font-geist-mono uppercase tracking-widest text-exvia-gold">
                {testimonialsConfig.label}
              </span>
            </div>
          )}
        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Image Side */}
            <div className="relative aspect-[4/5] lg:aspect-[3/4] overflow-hidden bg-exvia-base-black rounded-lg">
            ...
            <div className="space-y-8">
                  ...
                  <Star
                    ...
                    className={cn(
                      ...
                      i < testimonials[activeIndex].rating
                        ? 'fill-exvia-gold text-exvia-gold'
                        : 'text-white/20'
                    )}
              ...
              <div className="relative min-h-[180px]">
                {testimonials.map((testimonial, index) => (
                  <p
                    key={index}
                    className={cn(
                      'text-xl lg:text-2xl text-white/90 leading-relaxed absolute inset-0 transition-all duration-700 ease-out-quart',
                      index === activeIndex
                        ? 'opacity-100 translate-y-0'
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={prevSlide}
                    className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:border-exvia-gold hover:bg-exvia-gold hover:text-exvia-black transition-all duration-300"
