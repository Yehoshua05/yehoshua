...
function ProjectCard({ project, index, isVisible }: { project: { title: string; category: string; year: string; image: string; featured?: boolean }; index: number; isVisible: boolean }) {
  return (
    ...
    >
      <div className="relative overflow-hidden bg-exvia-black">
        <div className={cn(
          'aspect-[4/3]',
      ...
      <div className="mt-4 space-y-1">
        <h3 className="text-lg font-semibold text-white group-hover:text-exvia-gold transition-colors">
          {project.title}
        </h3>
...
export function Portfolio() {
  ...
  return (
    <section id="portfolio" className="w-full py-24 lg:py-32 bg-exvia-base-black">
      <div className="container-large px-6 lg:px-12">
        ...
        {portfolioConfig.viewAllLabel && (
          ...
          >
            <button className="group inline-flex items-center gap-2 text-sm font-geist-mono text-white hover:text-exvia-gold transition-colors">
