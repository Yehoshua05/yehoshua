...
import { Code, Layers, Layout, Database, Circle, type LucideIcon } from 'lucide-react';
    ...
    >
      <div className="flex flex-col lg:flex-row lg:items-start gap-6">
        ...
        <div className="flex-shrink-0">
          <div className="w-12 h-12 flex items-center justify-center border border-exvia-border rounded-lg bg-exvia-base-black">
            <Icon className="w-5 h-5 text-exvia-gold" />
          </div>
        </div>

        {/* Content */}
        <div className="flex-1 space-y-3">
          <h3 className="text-h5 font-semibold text-white">{service.title}</h3>
        ...
        {/* Index Number */}
        <div className="hidden lg:block text-xs font-geist-mono text-exvia-gold/50">
          0{index + 1}
        </div>
      </div>
...
export function Services() {
  ...
  return (
    <section id="services" className="w-full py-24 lg:py-32 bg-exvia-black">
